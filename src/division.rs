    ...
    I: Clone + GenericInteger,
{
    ...
    let mut ptr: I = match dividend.cmp(&divisor) {
        ...
        Ordering::Greater => {
            ...
            loop {
                if ptr > dividend {
                    if I::maybe_one().map_or_else(|| ptr > I::one(), |_1| ptr > *_1) {
                        I::maybe_ten().map(|_10| ptr /= _10).or_else(|| {
                            ptr /= I::ten();
                            None
                        });
                    }
                ...
                ptr = match I::maybe_ten()
                    .map_or_else(|| ptr.checked_mul(&I::ten()), |_10| ptr.checked_mul(_10))
                {
                    Some(n) => n,
                    None => break,
                };
    ...
    loop {
        ...
        if I::maybe_zero().map_or_else(|| digit > I::zero(), |_0| digit > *_0) {
